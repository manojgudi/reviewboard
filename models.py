...
class Review(db.Model):
    ...
    # Highlight positions (normalized 0-1 relative to PDF viewport)
    highlight_x = db.Column(db.Float, nullable=True)
    highlight_y = db.Column(db.Float, nullable=True)
    highlight_width = db.Column(db.Float, nullable=True)
    highlight_height = db.Column(db.Float, nullable=True)
